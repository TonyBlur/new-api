...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.POST("/antigravity/oauth/start", controller.GenerateAntigravityAuthURL)
		channelRoute.POST("/antigravity/oauth/complete", controller.ExchangeAntigravityToken)
		channelRoute.POST("/antigravity/oauth/update", controller.UpdateAntigravityChannelKey)
